...
//  source: https://github.com/raywenderlich/swift-algorithm-club/blob/master/Trie/Trie/Trie/Trie.swift
//
...
protocol SuggestionsRepository {
    ...
    func contains(word: String, matchPrefix: Bool) -> Bool
...
/// character of a word.
class Trie: NSObject, NSCoding, SuggestionsRepository {
